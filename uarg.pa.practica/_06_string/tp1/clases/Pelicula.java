...
public class Pelicula {
    ...
    public Pelicula(String titulo, String director, Genero genero, int AniodePublicacion, int contenidopelicula, int duracion) {
        this.titulo = titulo;
        ...
        public int setcontenidopelicula(){
        ...
        return "[ " + this.titulo + "] [ " + this.director + "] [ " + this.genero + "] [ " + this.AniodePublicacion + "] [ " + this.contenidopelicula + "] [ " + this.duracion + "]";
    }
}
